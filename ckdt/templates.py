# Templates used by the Charmed Kubernetes Doc Tools, gathered in one place for easier tweaking
...
which comprise the {{release}} release of Charmed Kubernetes. This is primarily a
...
<tr>
  ...
  <td> <a href="https://jaas.ai/{{c.name}}/{{c.revision}}">{{c.revision}}</a> </td>
  <td> -- </td>
</tr>
{% endfor %}
 </tbody>
